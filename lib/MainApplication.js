...
/***/ function(module, exports, __webpack_require__) {
	...
	if (parameters.filetype) {
	    (function () {
	        ...
	        parameters.filetype.split(".").map(function (it) {
	...
	_(fileNames).map(function (snippetFileName) {
	    return UltiSnippetParser_1.parseSnippets(snippetFileName, fs.readFileSync(snippetFileName, "utf-8"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function parseSnippets(snippetsFile, snippetCode) {
	    var result = [];
	        ...
	        if (state == ReadState.BLANK) {
	            ...
	            if (/^extends .+?$/.test(line)) {
	                try {
	                    ...
	                    var extraSnippets = parseSnippets(typeExtendedSnippetFile, fs.readFileSync(typeExtendedSnippetFile, "utf-8"));
